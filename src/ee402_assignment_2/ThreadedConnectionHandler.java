...
public class ThreadedConnectionHandler extends Thread
{
    ...
    private RobotCommandListener theListener; 
    
	// The constructor for the connection handler
    public ThreadedConnectionHandler(Socket clientSocket, RobotCommandListener robotCommandListener  ) {
        this.clientSocket = clientSocket;
        this.theListener = robotCommandListener; 
    ...
    private boolean readCommand() {
        ...
        theListener.onCommandReceived(s);
