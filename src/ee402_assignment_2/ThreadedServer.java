...
public class ThreadedServer 
{
	...
	public static void start(RobotCommandListener robotCommandListener ) {
        ...
        while (listening) // almost infinite loop - loop once for each client request
        {
            ...
            ThreadedConnectionHandler con = new ThreadedConnectionHandler(clientSocket,robotCommandListener);
            con.start(); 
